...
The initial goal was to run on cheap OpenWrt routers such as TP-Link Wr703N but since there are other hardware using the same SoC with OpenWrt this solution may work on boards like Carambola2, Arduino Y√√√∫n, etc.
